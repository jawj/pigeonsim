  ...
  google.setOnLoadCallback(function() {
    ...
    resetCam = function(lat, lon, heading) {
      ...
      if (params.hud) {
        ...
        posArray = [];
        return poly.setPath(posArray);
      }
    };
    moveCam = function() {
      var c, currentPos, path, unmoved, view;
      camMoves += 1;
      if (params.debugData) {
