(function() {
  ...
  this.DistanceSensorSet = (function() {

    __extends(DistanceSensorSet, FeatureSet);

    function DistanceSensorSet(featureManager) {
      var dis_crystal, dis_event, dis_sensor, dis_sound_sensor, distance_wind_sensor, lat, lfs, lon, name, row, _i, _len, _ref, _ref2;
  ...
  this.DistanceEventLocation = (function() {

    __extends(DistanceEventLocation, Feature);

    function DistanceEventLocation() {
      DistanceEventLocation.__super__.constructor.apply(this, arguments);
    }
  ...
  this.DistanceFeature = (function() {

    __extends(DistanceFeature, Feature);

    function DistanceFeature() {
      DistanceFeature.__super__.constructor.apply(this, arguments);
    }
  ...
  this.DistanceTempSensor = (function() {

    __extends(DistanceTempSensor, Feature);

    function DistanceTempSensor() {
      DistanceTempSensor.__super__.constructor.apply(this, arguments);
    }
  ...
  this.DistanceWindSensor = (function() {

    __extends(DistanceWindSensor, Feature);

    function DistanceWindSensor() {
      DistanceWindSensor.__super__.constructor.apply(this, arguments);
    }
  ...
  this.DistanceSoundSensor = (function() {

    __extends(DistanceSoundSensor, Feature);

    function DistanceSoundSensor() {
      DistanceSoundSensor.__super__.constructor.apply(this, arguments);
    }
