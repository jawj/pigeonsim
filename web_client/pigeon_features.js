...
(function() {
  var box, load, mergeObj, oneEightyOverPi, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  this.TubeStationSet = (function(_super) {
    ...
    function TubeStationSet(featureManager) {
      var code, dummy, lat, lon, name, row, station, _i, _len, _ref1, _ref2;
  ...
  this.TubeStation = (function(_super) {
    ...
    function TubeStation() {
      _ref1 = TubeStation.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  this.CityHall = (function(_super) {
    ...
    function CityHall() {
      _ref2 = CityHall.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  this.CASALogo = (function(_super) {
    ...
    function CASALogo() {
      _ref3 = CASALogo.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  this.CASAConf = (function(_super) {
    ...
    function CASAConf() {
      _ref4 = CASAConf.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    CASAConf.prototype.update = function() {
      var changed, d, d0, dayHrs, dayMs, desc, i, self, session, _i, _len, _ref5;
  ...
  this.TubeStation = (function(_super) {
    ...
    function TubeStation() {
      _ref5 = TubeStation.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  this.BigBen = (function(_super) {
    ...
    function BigBen() {
      _ref6 = BigBen.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  this.TowerBridge = (function(_super) {
    ...
    function TowerBridge() {
      _ref7 = TowerBridge.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    TowerBridge.prototype.update = function() {
      ...
      load({
        ...
        cells = (function() {
          ...
          _ref8 = data.querySelectorAll('td');
          _results = [];
  ...
  this.LondonTweetSet = (function(_super) {
    ...
    LondonTweetSet.prototype.update = function() {
      ...
      load({
        ...
        var dedupedTweets, i, k, lat, lon, t, tweet, _i, _len, _ref8, _results;

        _this.clearFeatures();
        dedupedTweets = {};
        _ref8 = data.results.slice(-_this.maxTweets);
  ...
  this.Tweet = (function(_super) {
    ...
    function Tweet() {
      _ref8 = Tweet.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  this.LondonAir = (function(_super) {
    ...
    function LondonAir() {
      _ref9 = LondonAir.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    LondonTrafficSet.prototype.update = function() {
      ...
      load({
        ...
        for (_i = 0, _len = lines.length; _i < _len; _i++) {
          ...
          a.name = cells[11];
          a.desc = ((function() {
            var _j, _len1, _ref10, _results1;

            _ref10 = cells.slice(5, 9);
            _results1 = [];
  ...
  this.LondonTraffic = (function(_super) {
    ...
    function LondonTraffic() {
      _ref10 = LondonTraffic.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
  ...
  this.TideGauge = (function(_super) {
    ...
    function TideGauge() {
      _ref11 = TideGauge.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  this.OlympicSet = (function(_super) {
    ...
    function OlympicSet(featureManager) {
      var code, date, day, desc, end, lat, lon, name, row, sport, start, t1, t2, times, venue, _base, _i, _j, _len, _len1, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17;

      OlympicSet.__super__.constructor.call(this, featureManager);
      this.venues = [];
      this.events = {};
      _ref12 = this.venueData.split("\n");
      for (_i = 0, _len = _ref12.length; _i < _len; _i++) {
        row = _ref12[_i];
        _ref13 = row.split("\t"), lat = _ref13[0], lon = _ref13[1], name = _ref13[2];
      ...
      _ref14 = this.eventData.split("\n");
      for (_j = 0, _len1 = _ref14.length; _j < _len1; _j++) {
        row = _ref14[_j];
        _ref15 = row.split("\t"), day = _ref15[0], date = _ref15[1], times = _ref15[2], sport = _ref15[3], desc = _ref15[4], code = _ref15[5], venue = _ref15[6];
        _ref16 = times.split("-"), t1 = _ref16[0], t2 = _ref16[1];
        start = new Date("" + date + " " + t1);
        end = new Date("" + date + " " + t2);
        if ((_ref17 = (_base = this.events)[venue]) == null) {
          _base[venue] = [];
        }
    ...
    OlympicSet.prototype.update = function() {
      var a, event, i, nextEvent, now, self, venue, _i, _j, _len, _len1, _ref12, _ref13, _ref14, _ref15;
      ...
      for (i = _i = 0, _len = _ref12.length; _i < _len; i = ++_i) {
        ...
        a.name = "\uF003 " + venue.name;
        a.alt += (i % 5) * 30;
        if ((_ref13 = venue.name) !== 'Orbit') {
          now = new Date();
          nextEvent = null;
          _ref15 = (_ref14 = this.events[venue.name]) != null ? _ref14 : [];
  ...
  this.OlympicVenue = (function(_super) {
    ...
    function OlympicVenue() {
      _ref12 = OlympicVenue.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
