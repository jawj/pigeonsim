...
(function() {
  var box, load, mergeObj, oneEightyOverPi, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  this.Helen = (function(_super) {
    __extends(Helen, _super);

    function Helen() {
      _ref13 = Helen.__super__.constructor.apply(this, arguments);
      return _ref13;
    }

    Helen.prototype.alt = 170;

    Helen.prototype.nameTextOpts = {
      size: 3,
      lineWidth: 2
    };

    Helen.prototype.descTextOpts = {
      size: 2,
      lineWidth: 1
    };

    Helen.prototype.name = "but you'll always know where to find us!";

    Helen.prototype.desc = "...... Steve x :)";
  ...
  this.CityHall = (function(_super) {
    ...
    function CityHall() {
      _ref14 = CityHall.__super__.constructor.apply(this, arguments);
      return _ref14;
    }
  ...
  this.CASALogo = (function(_super) {
    ...
    function CASALogo() {
      _ref15 = CASALogo.__super__.constructor.apply(this, arguments);
      return _ref15;
    }
  ...
  this.CASAConf = (function(_super) {
    ...
    function CASAConf() {
      _ref16 = CASAConf.__super__.constructor.apply(this, arguments);
      return _ref16;
    }
    ...
    CASAConf.prototype.update = function() {
      var changed, d, d0, dayHrs, dayMs, desc, i, self, session, _i, _len, _ref17;
      d = new Date();
      d0 = new Date(d.getFullYear(), d.getMonth(), d.getDate());
      dayMs = d - d0;
      dayHrs = dayMs / 1000 / 60 / 60;
      _ref17 = this.schedule;
  ...
  this.TubeStation = (function(_super) {
    ...
    function TubeStation() {
      _ref17 = TubeStation.__super__.constructor.apply(this, arguments);
      return _ref17;
    }
  ...
  this.BigBen = (function(_super) {
    ...
    function BigBen() {
      _ref18 = BigBen.__super__.constructor.apply(this, arguments);
      return _ref18;
    }
  ...
  this.TowerBridge = (function(_super) {
    ...
    function TowerBridge() {
      _ref19 = TowerBridge.__super__.constructor.apply(this, arguments);
      return _ref19;
    }
    ...
    TowerBridge.prototype.update = function() {
      ...
      load({
        ...
        cells = (function() {
          ...
          _ref20 = data.querySelectorAll('td');
          _results = [];
  ...
  this.LondonTweetSet = (function(_super) {
    ...
    LondonTweetSet.prototype.update = function() {
      ...
      load({
        ...
        var dedupedTweets, i, k, lat, lon, t, tweet, _i, _len, _ref20, _results;
        _this.clearFeatures();
        dedupedTweets = {};
        _ref20 = data.results.slice(-_this.maxTweets);
  ...
  this.Tweet = (function(_super) {
    ...
    function Tweet() {
      _ref20 = Tweet.__super__.constructor.apply(this, arguments);
      return _ref20;
    }
  ...
  this.LondonAir = (function(_super) {
    ...
    function LondonAir() {
      _ref21 = LondonAir.__super__.constructor.apply(this, arguments);
      return _ref21;
    }
    ...
    LondonTrafficSet.prototype.update = function() {
      ...
      load({
        ...
        for (_i = 0, _len = lines.length; _i < _len; _i++) {
          ...
          a.name = cells[11];
          a.desc = ((function() {
            var _j, _len1, _ref22, _results1;
            _ref22 = cells.slice(5, 9);
            _results1 = [];
  ...
  this.LondonTraffic = (function(_super) {
    ...
    function LondonTraffic() {
      _ref22 = LondonTraffic.__super__.constructor.apply(this, arguments);
      return _ref22;
    }
  ...
  this.TideGauge = (function(_super) {
    ...
    function TideGauge() {
      _ref23 = TideGauge.__super__.constructor.apply(this, arguments);
      return _ref23;
    }
  ...
  this.OlympicSet = (function(_super) {
    ...
    function OlympicSet(featureManager) {
      var code, date, day, desc, end, lat, lon, name, row, sport, start, t1, t2, times, venue, _base, _i, _j, _len, _len1, _ref24, _ref25, _ref26, _ref27, _ref28;
      OlympicSet.__super__.constructor.call(this, featureManager);
      this.venues = [];
      this.events = {};
      _ref24 = this.venueData.split("\n");
      for (_i = 0, _len = _ref24.length; _i < _len; _i++) {
        row = _ref24[_i];
        _ref25 = row.split("\t"), lat = _ref25[0], lon = _ref25[1], name = _ref25[2];
      ...
      _ref26 = this.eventData.split("\n");
      for (_j = 0, _len1 = _ref26.length; _j < _len1; _j++) {
        row = _ref26[_j];
        _ref27 = row.split("\t"), day = _ref27[0], date = _ref27[1], times = _ref27[2], sport = _ref27[3], desc = _ref27[4], code = _ref27[5], venue = _ref27[6];
        _ref28 = times.split("-"), t1 = _ref28[0], t2 = _ref28[1];
    ...
    OlympicSet.prototype.update = function() {
      var a, event, i, nextEvent, now, self, venue, _i, _j, _len, _len1, _ref24, _ref25, _ref26, _ref27;
      this.clearFeatures();
      _ref24 = this.venues;
      for (i = _i = 0, _len = _ref24.length; _i < _len; i = ++_i) {
        ...
        a.name = "\uF003 " + venue.name;
        a.alt += (i % 5) * 30;
        if ((_ref25 = venue.name) !== 'Orbit') {
          now = new Date();
          nextEvent = null;
          _ref27 = (_ref26 = this.events[venue.name]) != null ? _ref26 : [];
  ...
  this.OlympicVenue = (function(_super) {
    ...
    function OlympicVenue() {
      _ref24 = OlympicVenue.__super__.constructor.apply(this, arguments);
      return _ref24;
    }
