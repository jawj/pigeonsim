  ...
  this.SkyText = (function() {
    ...
    function SkyText(lat, lon, alt, o) {
      ...
      this.alt = alt;
      if (o == null) o = {};
      if ((_ref = o.lineWidth) == null) o.lineWidth = 1;
      if ((_ref2 = o.colour) == null) o.colour = 'ffffffff';
      this.allCoordSets = [];
      this.lineOpts = [];
      if (o.lineWidth > 0) {
    ...
    SkyText.prototype.line = function(text, o) {
      var absX, alt, bRad, char, coords, cosB, i, lat, latFactor, latStart, lineCoordSets, lon, lonFactor, lonStart, maxX, path, paths, sinB, tabWidth, x, xCursor, y, _i, _j, _len, _len2, _ref, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (o == null) o = {};
      if ((_ref = o.bearing) == null) o.bearing = 0;
      if ((_ref2 = o.size) == null) o.size = 2;
      if ((_ref3 = o.lineWidth) == null) o.lineWidth = 2;
      if ((_ref4 = o.colour) == null) o.colour = 'ffffffff';
      if ((_ref5 = o.lineSpace) == null) o.lineSpace = 1;
      if ((_ref6 = o.charSpace) == null) o.charSpace = 1;
      if ((_ref7 = o.spaceWidth) == null) o.spaceWidth = 2;
      if ((_ref8 = o.tabSpaces) == null) o.tabSpaces = 4;
      if ((_ref9 = o.offset) == null) o.offset = 5;
      if ((_ref10 = o.font) == null) o.font = this.font;
